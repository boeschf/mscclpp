...
using allowed_nvl_ranks  = detail::powers_of_two_up_to<NUM_MAX_NVL_PEERS>;
using allowed_rdma_ranks = value_switch<EP_RDMA_RANKS>;
using allowed_hidden_sizes = value_switch<EP_HIDDEN_SIZES>;
using supported_dtypes = type_switch<type_case<CUDA_R_16BF, nv_bfloat16>, type_case<CUDA_R_32F,  float>>;
